...
public class PmsOssController {
    String accessId = "LTAI5tNZtcLo7Yugrw6FvKDo"; // 请填写您的AccessKeyId。
    String accessKey = "qjDCoKPYfQ3kmuHRO9ScDr1iINAnMr"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "lyc-ggmall"; // 请填写您的 bucketname 。
